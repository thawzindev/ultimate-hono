...
import { createServiceRegistry, ServiceRegistry } from '../modules/microservices';
...
// Register a service
microservicesRouter.app.post('/register', validateBody(registerServiceSchema), async c => {
  try {
...
// Service heartbeat
microservicesRouter.app.post('/heartbeat', validateBody(heartbeatSchema), async c => {
  try {
